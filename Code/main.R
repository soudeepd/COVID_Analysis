...
rho_vec_tmp_training1 = c(0.1, 0.5, 0.75, 1, 1.5, 3)
rho_vec_sp_training1 = c(0.01, 0.1, 0.5, 0.75, 1)
...
for(rho_tmp in rho_vec_tmp_training1){
  for (rho_sp in rho_vec_sp_training1) {
    ...
    significance_vec = c(significance_vec, unname(!(0 >= quantile(theta_sample_training1[1,], 0.025) & 
                                                      0 <= quantile(theta_sample_training1[1,], 0.975))))
    significance_vec = c(significance_vec, unname(!(0 >= quantile(theta_sample_training1[2,], 0.025) & 
                                                      0 <= quantile(theta_sample_training1[2,], 0.975))))
    significance_vec = c(significance_vec, unname(!(0 >= quantile(theta_sample_training1[3,], 0.025) & 
                                                      0 <= quantile(theta_sample_training1[3,], 0.975))))
    significance_vec = c(significance_vec, unname(!(0 >= quantile(theta_sample_training1[4,], 0.025) & 
                                                      0 <= quantile(theta_sample_training1[4,], 0.975))))
    significance_vec = c(significance_vec, unname(!(0 >= quantile(theta_sample_training1[5,], 0.025) & 
                                                      0 <= quantile(theta_sample_training1[5,], 0.975))))
...
SIGMA_sp_full_training1 = exp(-rho_sp*distance_mat_full_training1/80000) #to get data similar to temporal matrix values
...
rho_vec_tmp_training2 = c(0.1, 0.5, 0.75, 1, 1.5, 3)
rho_vec_sp_training2 = c(0.01, 0.1, 0.5, 0.75, 1)
